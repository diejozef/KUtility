...
{
public:
	virtual void DrawString(Vec2 const& Position, Vec4 const& Color, const char* Text, ...) = 0;
	...
	virtual IFont* BuildFont(const char* Typeface, float Size, int Style = kFontWeightNormal) = 0;
...
public:
	...
	virtual bool WithinFogOfWar(Vec3 const& Pos) = 0;
